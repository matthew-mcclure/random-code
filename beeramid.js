...
To celebrate, you're taking your team out to the terrible dive bar next door and using the referral bonus to buy, and build, 
...
var beeramid = function(bonus, price) {
  var beerCount = Math.floor(bonus / price)
  var levels = 0
  for(var i = 1; beerCount > 0; i++) {
    if(beerCount >= i * i) levels++
    beerCount = beerCount - i * i
  }
  return levels
}
